...
class AppmakerTests(unittest.TestCase):
    ...
    def test_no_app_root(self):
        ...
        root = {}
        self._callFUT(root)
        self.assertEqual(root['bfgsite']['profiles']['admin'].fullname,
                         'Ad Min')
        self.assertEqual(root['bfgsite']['profiles']['admin'].email,
                         'admin@example.com')
        self.assertEqual(root['bfgsite'].users.__class__, Users)
